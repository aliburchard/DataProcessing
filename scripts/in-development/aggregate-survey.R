...
library(dplyr)
library(magrittr)
source("scripts/aggregate_functions.r")

raw_data <- read.csv("data/michigan-zoomin-flattened.csv")# note that the total_species count reported here isn't accurate when users report the same species multiple times. 
head(raw_data)
